...
void ScrollUp(String [] array, String input,String response)
{
  int linecount=0;
  String [] responses;
...
void endScroll(String [] array, String input)
{
...
void createMap(String [] sArray,String [] [] xArray)
{
  int row=0;
  int col=0;
  for(int i=1;i<=15;i++)
...
void saveGame()
{
  ...
  saveState[0]=name;
  saveState[1]=char(row+65)+" ";
  saveState[2]=char(col+65)+" ";
  for(int i=3;i<43;i++)
...
String use(String item, Object object)
{
